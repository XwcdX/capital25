...
<section id="rules" class="h-screen w-screen bg-[#dad7cf] overflow-hidden flex max-sm:flex-col items-center justify-center max-sm:space-y-4 sm:space-x-4">
    {{-- <h1 class="text-6xl lg:text-7xl text-[#14240a] z-[7] text-white font-oxanium font-black ">Rules</h1>     --}}
    <div class="w-[250px] h-[250px] md:w-[350px] md:h-[350px] flex flex-col items-center justify-center">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="glow cursor-pointer rule"
            width="250pt" height="250pt" viewBox="0 0 2048.000000 2048.000000"
            preserveAspectRatio="xMidYMid meet">
            
            <g transform="translate(0.000000,2048.000000) scale(0.100000,-0.100000)"
            fill="#14240a" stroke="none" class="glow-button">
    ...
    <div class="w-[250px] h-[250px] md:w-[350px] md:h-[350px] flex flex-col items-center justify-center">
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="glow-svg cursor-pointer rule"
        width="250pt" height="250pt" viewBox="0 0 2048.000000 2048.000000"
        preserveAspectRatio="xMidYMid meet">
