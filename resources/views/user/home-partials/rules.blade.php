...
<section id="rules" class="relative h-screen w-screen bg-[var(--cap-green3)] overflow-hidden flex flex-col items-center md:items-start justify-center p-20">
    {{-- <h1 class="text-6xl lg:text-7xl text-[#14240a] z-[7] text-white font-oxanium font-black ">Rules</h1>     --}}
    <div class="flex max-md:flex-col max-md:space-y-16 md:space-x-8 lg:space-x-20 xl:space-x-28 md:ml-4 lg:ml-12 [@media(min-width:1350px)]:ml-40" data-aos="fade-left" data-aos-duration="1000">
        ...
        <div class="w-[150px] md:w-[200px] lg:w-[250px] xl:w-[300px] flex flex-col items-center justify-center" data-aos="fade-left" data-aos-duration="1000">
    ...
    <img class="sprouty absolute z-[20] bottom-0 md:bottom-[15%] lg:bottom-[5%] xl:bottom-0 right-0 w-[165px] md:w-[250px] lg:w-[350px] xl:w-[450px]" src="{{ asset('assets/rules/sprouty.png')}}" alt=""
