...
-mt-[49%] sm:-mt-[22%] md:-mt-[17%] lg:-mt-[15%] xl:-mt-[9%]">
    ...
    <div class="flex max-md:flex-col max-md:flex-col-reverse z-[13] justify-center space-x-4 w-full xl:w-[90%]">
        {{-- moni --}}
        <img class="hidden md:block object-cover h-[200px] md:h-[350px] lg:h-[500px] my-auto moni" src=" {{ asset('assets/about/moni.png')}}" alt="">
        <img class="moni block md:hidden absolute z-[13] h-[300px] -bottom-[15%] left-1/2 -translate-x-1/2 object-cover"
